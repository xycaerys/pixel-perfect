  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-background/95 backdrop-blur-md border-b border-muted shadow-lg"
          : "bg-transparent"
      }`}
    >
            ...
            {navLinks.map((link) => (
              <li key={link.id}>
                <button
                  ...
                  className="text-muted-foreground hover:text-gold transition-colors duration-300 font-medium text-sm tracking-wide"
                >
                  {link.label}
                </button>
              </li>
